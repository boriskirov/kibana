...
export declare const getTooltipActions: (dataLayers: CommonXYDataLayerConfig[], onClickMultiValue: (data: MultiFilterEvent["data"]) => void, onCreateAlertRule: (data: AlertRuleFromVisUIActionData) => void, fieldFormats: LayersFieldFormats, formattedDatatables: DatatablesWithFormatInfo, xAxisFormatter: FieldFormat, formatFactory: FormatFactory, isEsqlMode?: boolean, canCreateAlerts?: boolean, isEnabled?: boolean, onOpenInsights?: () => void, getInsightCount?: () => number) => TooltipAction<any, XYChartSeriesIdentifier<any>>[] | undefined;
