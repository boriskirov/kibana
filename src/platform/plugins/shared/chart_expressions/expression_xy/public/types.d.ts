...
import type { CellValueContext, RangeSelectContext, ValueClickContext, MultiValueClickContext } from '@kbn/embeddable-plugin/public';
...
export interface ExpressionXyPluginSetup {
    registerChartTooltipInsightsHandler: (onOpen: () => void, options?: {
        getCount?: () => number;
    }) => void;
...
export type GetCompatibleCellValueActions = (data: CellValueContext['data']) => Promise<CellValueAction[]>;
