...
export declare const registerChartTooltipInsightsHandler: (onOpen: () => void, options?: {
    getCount?: () => number;
}) => void;
export declare const registerChartAnnotationOverrides: (getInjected: () => InjectedAnnotations) => void;
